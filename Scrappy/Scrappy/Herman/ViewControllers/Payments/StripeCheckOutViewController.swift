...
class StripeCheckOutViewController: UIViewController, STPPaymentContextDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.productLabel.font = UIFont.systemFont(ofSize: 70)
    ...
    override func viewDidLayoutSubviews() {
        ...
        self.productLabel.center = CGPoint(x: width/2.0,
                                           y: self.productLabel.bounds.height/1.0 + rowHeight)
        self.paymentRow.frame = CGRect(x: insets.left, y: self.productLabel.frame.maxY + rowHeight,
    ...
    func paymentContext(_ paymentContext: STPPaymentContext, didFinishWith status: STPPaymentStatus, error: Error?) {
        ...
        case .error:
            ...
            let userPaymentFailedVC = UserPaymentFailedViewController()
            userPaymentFailedVC.modalPresentationStyle = .overCurrentContext
            present(userPaymentFailedVC, animated: true, completion: nil)
