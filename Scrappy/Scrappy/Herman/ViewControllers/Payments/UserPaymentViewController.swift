...
class UserPaymentViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        userPaymentInputViews.cardNumberTextField.addTarget(self, action: #selector(cardNumberTextChanged), for: .editingChanged)
        userPaymentInputViews.cardHolderTextField.addTarget(self, action: #selector(cardHolderTextChanged), for: .editingChanged)
        userPaymentInputViews.expDateTextField.addTarget(self, action: #selector(expDateTextChanged), for: .editingChanged)
        userPaymentInputViews.cvvNumberTextField.addTarget(self, action: #selector(cvvTextChanged), for: .editingChanged)
        userPaymentInputViews.nextButton.addTarget(self, action: #selector(nextButtonTapped), for: .touchUpInside)
    }
    ...
    @objc func nextButtonTapped() {
        ...
        case 20.0:
            ...
            UIView.animate(withDuration: 0.4, animations: {
                ...
                self.userPaymentInputViews.cardHolderTextField.becomeFirstResponder()
            }
        ...
        case -(self.view.frame.width - 20):
            ...
            UIView.animate(withDuration: 0.35, animations: {
                ...
                self.userPaymentInputViews.expDateTextField.becomeFirstResponder()
            }
        ...
        case -(self.view.frame.width * 2 - 20):
            ...
            UIView.animate(withDuration: 0.3, animations: {
                ...
                self.userPaymentInputViews.cvvNumberTextField.becomeFirstResponder()
            }
